...
<div class="main-header side-header sticky">
    <div class="main-container container-fluid">
        <div class="main-header-left">
            ...
            <div class="hor-logo">
                <a class="main-logo" href="https://laravelui.spruko.com/dashplex/index">
        ...
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="https://laravelui.spruko.com/dashplex/index"><img
                        src="{{ asset('assets/img/brand/logo.png') }}" class="mobile-logo" alt="logo"></a>
                <a href="https://laravelui.spruko.com/dashplex/index"><img
                        src="{{ asset('assets/img/brand/logo-light.png') }}" class="mobile-logo-dark"
                        alt="logo"></a>
            </div>
        </div>
