                ...
                <ul class="menu-nav nav">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                            ...
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{route('users-management.create')}}">Users Create</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                            ...
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{route('interventions.index')}}">Interventions List</a>
                            </li>
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{route('interventions.create')}}">Interventions Create</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav-sub">
                            ...
                            <li class="nav-sub-item">
                                <a class="nav-sub-link" href="{{route('contracts.create')}}">Contract Create</a>
                            </li>
                        </ul>
                    </li>
                </ul>
