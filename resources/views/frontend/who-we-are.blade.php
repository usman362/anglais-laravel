            ...
            <div class="row g-5">
                    ...
                    <div class="service-one-inner-four">
                        <div class="big-thumbnail-area">
                            <a href="#" class="thumbnail">
                                <img src="{{asset('frontend/assets/images/service/07.jpg')}}" alt="Business-service">
                            </a>
                            <div class="content">
                                <img src="{{asset('frontend/assets/images/service/icon/16.svg')}}" alt="Business-icon">
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12 pt--15 mb--80 mb_md--40 mb_sm--30">
                    <div class="service-one-inner-four">
                        <div class="big-thumbnail-area">
                            <a href="#" class="thumbnail">
                                <img src="{{asset('frontend/assets/images/service/08.jpg')}}" alt="Business-service">
                            </a>
                            <div class="content">
                                <img src="{{asset('frontend/assets/images/service/icon/14.svg')}}" alt="Business-icon">
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12 pt--15 mb--80">
                    <div class="service-one-inner-four">
                        <div class="big-thumbnail-area">
                            <a href="#" class="thumbnail">
                                <img src="{{asset('frontend/assets/images/service/09.jpg')}}" alt="Business-service">
                            </a>
                            <div class="content">
                                <img src="{{asset('frontend/assets/images/service/icon/15.svg')}}" alt="Business-icon">
    ...
    <div class="container">
        ...
        <div class="row g-5 mt--15 mt_sm--0">
            ...
            <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="team-inner-two">
                    <a href="team-details.html" class="thumbnail">
                        <img src="{{asset('frontend/assets/images/team/tm/lg-01.jpg')}}" alt="">
                    </a>
                    <!-- Acquaintance area -->
            ...
            <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="team-inner-two">
                    <a href="team-details.html" class="thumbnail">
                        <img src="{{asset('frontend/assets/images/team/tm/lg-02.jpg')}}" alt="">
                    </a>
                    <!-- Acquaintance area -->
                    <div class="acquaintance-area">
                        <div class="header">
            ...
            <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="team-inner-two">
                    <a href="team-details.html" class="thumbnail">
                        <img src="{{asset('frontend/assets/images/team/tm/lg-03.jpg')}}" alt="">
                    </a>
                    <!-- Acquaintance area -->
                    <div class="acquaintance-area">
                        <div class="header">
