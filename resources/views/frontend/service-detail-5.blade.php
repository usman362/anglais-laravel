...
@section('content')
    ...
    <div class="breadcrumb-bg bg_image notranslate"
        style="background-image: url({{ asset('frontend/assets/images/service-8.jpeg') }})">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-12">
                    ...
                    <div class="service-detials-step-1">
                        <p class="disc">
                            Gérer ses papiers, comprendre des démarches ou rédiger un courrier peut devenir un véritable
                            casse-tête, surtout face à des procédures de plus en plus dématérialisées. Lʼautonomie
                            passeaussi par la maîtrise de lʼadministratif, cʼest pourquoi nous proposons un accompagnement
                            humain, patient et adapté à chaque situation.
                        </p>

                        <h4 class="title pink-text"><img src="{{ asset('frontend/assets/images/icon/27.png') }}"
                                width="54" alt=""> Aide aux démarches administratives</h4>
                        <p class="disc">
                        ...
                        <ul>
                            ...
                            <li>Mise à jour de documents administratifs (changement dʼadresse, renouvellement de pièces,
                                etc.)</li>
                        </ul>
                        Nos intervenants prennent le temps dʼexpliquer chaque étape, de rassurer et de guider, dans le
                        respect des choix et de la confidentialité.
                        </p>

                        <h4 class="title pink-text"><img src="{{ asset('frontend/assets/images/icon/28.png') }}"
                                width="54" alt=""> Rédaction de courriers et courriels</h4>
                        <p class="disc">
                            Nous proposons également une aide à la rédaction de lettres, courriels ou formulaires, quʼil
                            sʼagisse :
                        <ul>
                        ...
                        Nos équipes sʼadaptent aux besoins et au niveau de familiarité avec lʼécrit ou lʼoutil numérique.
                        Dans certains cas, nous pouvons aussi accompagner dans lʼutilisation de lʼordinateur, du téléphone
                        ou de la messagerie en ligne.
                        </p>

                        <p class="disc">
                            Chez <span
                                style="font-weight: 1000; font-style: italic; font-family: cursive; font-size: 18px;">agapé</span>,
                            lʼappui administratif est plus quʼun simple service : cʼest
                            un soutien concret à lʼautonomie et à la tranquillité dʼesprit, pour que chacun puisse faire
                            valoir ses droits, rester informé et conserver le contrôle de ses démarches, sans stress ni
                            confusion.
                        </p>
