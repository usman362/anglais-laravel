...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        if (count($usersList) > 0) {
            ...
            $contacts = '<p class="message-hint center-el"><span>Votre liste de contacts est vide</span></p>';
        }
    ...
    public function search(Request $request)
    {
        ...
        if($records->total() < 1){
            $getRecords = '<p class="message-hint center-el"><span>Rien à montrer.</span></p>';
        }
        // send the response
        return Response::json([
            'records' => $getRecords,
    ...
    public function sharedPhotos(Request $request)
    {
        ...
        // send the response
        return Response::json([
            'shared' => count($shared) > 0 ? $sharedPhotos : "<p class='message-hint'><span>Rien de partagé pour l'instant</span></p>",
        ], 200);
    }
